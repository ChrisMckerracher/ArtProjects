<script lang="ts">
    ...
    let properties: Array<Property> = [
        ...
        new Property("--swirlie-thickness", 1, 20, "vw"),
        new Property("--swirlie-blend", 0, 100, "px"),
        new Property("--swirlie-length", 1, 10, "px"),
